...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 17428640,
    DYNAMIC_BASE = 17428640,
    DYNAMICTOP_PTR = 12185728;
...
// STATICTOP = STATIC_BASE + 12184736;
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 12185632, 4), 12185632);function _gmtime_r(time, tmPtr) {
...
var _av_log_set_level = Module["_av_log_set_level"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_av_log_set_level"].apply(null, arguments)
};
...
var _transcoding = Module["_transcoding"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_transcoding"].apply(null, arguments)
};
