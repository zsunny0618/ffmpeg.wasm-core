...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 17037904,
    DYNAMIC_BASE = 17037904,
    DYNAMICTOP_PTR = 11794992;
...
// STATICTOP = STATIC_BASE + 11794000;
...
var tempDoublePtr;
if (!ENVIRONMENT_IS_PTHREAD) tempDoublePtr = 11795008;
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address; if (ENVIRONMENT_IS_PTHREAD) __main_thread_futex_wait_address = PthreadWorkerInit.__main_thread_futex_wait_address; else PthreadWorkerInit.__main_thread_futex_wait_address = __main_thread_futex_wait_address = 11794976;function _emscripten_futex_wake(addr, count) {
  ...
  //    dump('futex_wake addr:' + addr + ' by thread: ' + _pthread_self() + (ENVIRONMENT_IS_PTHREAD?'(pthread)':'') + '\n');
      ...
      throw 'Atomics.notify returned an unexpected value ' + ret;
        ...
        PThread.mainThreadBlock = 11794192;
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(27, 1, stream, iov, iovcnt, pnum);
  try {
  ...
  var ___tm_current; if (ENVIRONMENT_IS_PTHREAD) ___tm_current = PthreadWorkerInit.___tm_current; else PthreadWorkerInit.___tm_current = ___tm_current = 11794048;
  
  
  var ___tm_timezone; if (ENVIRONMENT_IS_PTHREAD) ___tm_timezone = PthreadWorkerInit.___tm_timezone; else PthreadWorkerInit.___tm_timezone = ___tm_timezone = (stringToUTF8("GMT", 11794096, 4), 11794096);function _gmtime_r(time, tmPtr) {
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(32, 1, name);
...
var proxiedFunctionTable = [null,___syscall10,___syscall102,___syscall122,___syscall140,___syscall142,___syscall145,___syscall168,___syscall192,___syscall195,___syscall196,___syscall197,___syscall220,___syscall221,___syscall3,___syscall33,___syscall340,___syscall38,___syscall39,___syscall4,___syscall40,___syscall5,___syscall54,___syscall6,___syscall75,___syscall77,___syscall91,_fd_write,_emscripten_set_canvas_element_size_main_thread,_getaddrinfo,_getenv,_tzset,_sysconf];
...
function nullFunc_viiiiiiiidddddi(x) { abortFnPtrError(x, 'viiiiiiiidddddi'); }
...
var dynCall_viiiiiiiidddddi = Module["dynCall_viiiiiiiidddddi"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_viiiiiiiidddddi"].apply(null, arguments)
};
